...
if run_clicked:
    try:
        with st.spinner("Reading workbook, running deposit automation, and reconciling QuickBooks lines..."):
            ...
            history_record = archive_run(uploaded, result, deposit_date, roles, date_info)
...
st.caption(
    "Successful app runs are recorded here. Start Over clears only the current work, not this history. "
